...
/****** Object:  View [dbo].[CUSTO_FECHAMENTO_MOV_INT_ENTRADAS]    Script Date: 02/11/2017 06:09:14 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[CUSTO_FECHAMENTO_MOV_INT_ENTRADAS]
AS
...
AND (D3_TM NOT IN ('900','400','499','999') OR (D3_TM = '499' AND D3_DOC LIKE 'INVENT%')) AND D3_OP = '' AND D3_TIPO <>'MO' AND D3_TM <= '499'  
